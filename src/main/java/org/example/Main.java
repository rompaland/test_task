...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Enter file1 and file2 name");
        String nameFiles = in.nextLine();
        String[] parts = nameFiles.split("[,\\s]+");
        ...
        try {
            ...
            System.out.println("File reading error" + parts[0]);
        }
        float x1 = myArray1[0];
        float y1 = myArray1[1];
        ...
        try {
            ...
            System.out.println("File reading error" + parts[1]);
        }
        for (int k = 0; k < j / 2; k++) {
